...
<p align="center">
  ...
  <a href="https://github.com/WanFengnie/LingMusic/releases/latest"><img alt="Latest Release" src="https://img.shields.io/github/v/release/WanFengnie/LingMusic?color=FC3C44&label=Version&logo=github"></a>
</p>
...
/WanFengnie/LingMusic/releases) 下载压缩包，解压后运行 `Ling.exe`。
...
不会。只扫描你添加或拖入的文件夹；单独拖入文件不会扫描其所在目录。
